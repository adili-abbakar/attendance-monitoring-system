...
@section('page-content')
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <!-- Mobile Header -->
        <header
            class="md:hidden fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 flex items-center px-4 z-40">
            ...
            <div class="flex-1 flex items-center justify-center">
                <div class="flex items-center gap-2">
                    ...
                    <span class="font-bold text-gray-900">AttendoQR</span>
                </div>
            </div>
        ...
        <!-- Mobile Drawer -->
        <div id="mobileDrawer" class="hidden fixed inset-0 z-30 md:hidden">
            <div class="fixed inset-0 bg-black/50" id="drawerBackdrop"></div>
            <nav class="fixed left-0 top-0 h-full w-64 bg-white shadow-lg overflow-y-auto pt-16">
                <div class="p-4 space-y-1">
                    <a href="dashboard.html"
                        class="flex items-center gap-3 px-4 py-3 bg-teal-50 text-teal-700 rounded-lg font-medium">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
